...
def _mint_user():
    seq = store_kv_incr("photos", "user_seq")
...
def _issue_tokens(user):
    access_seq = store_kv_incr("photos", "access_seq")
    refresh_seq = store_kv_incr("photos", "refresh_seq")
...
def on_authorize(req):
    ...
    code_seq = store_kv_incr("photos", "code_seq")
